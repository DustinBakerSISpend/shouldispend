export const calculators = [
  ...
  },
  {
    ...
    name: 'Professional Movers Cost Calculator',
    description: 'Estimate professional mover costs for local or long-distance moves, including crew labor, hourly rates, travel fees, packing, stairs, heavy items, insurance, tips, and shipment charges.',
    category: 'Moving',
    ...
    type: 'cost',
    isDecisionCalculator: false
  },
  {
    title: 'Moving Truck Rental Cost Calculator',
    name: 'Moving Truck Rental Cost Calculator',
    description: 'Estimate DIY moving truck rental costs, including base rate, rental days, mileage fees, fuel, insurance, equipment, tolls, parking, hotels, helper labor, and extra fees.',
    category: 'Moving',
    calculatorCategory: 'Moving',
  ...
  {
    title: 'Moving Storage Cost Calculator',
    name: 'Moving Storage Cost Calculator',
    description: 'Estimate temporary moving storage costs, including monthly unit or container charges, months needed, move-in fees, admin fees, lock fees, insurance, climate control, pickup and delivery, extra truck trips, labor, and taxes.',
    category: 'Moving',
    calculatorCategory: 'Moving',
  ...
  {
    title: 'Moving Boxes and Packing Supplies Cost Calculator',
    name: 'Moving Boxes and Packing Supplies Cost Calculator',
    description: 'Estimate moving boxes and packing supplies costs, including small, medium, large, wardrobe, and specialty boxes, tape, paper, bubble wrap, mattress bags, labels, furniture pads, reusable bins, free supplies, and last-minute extras.',
    category: 'Moving',
    calculatorCategory: 'Moving',
  ...
  {
    title: 'Lease Break Cost Calculator',
    name: 'Lease Break Cost Calculator',
    description: 'Estimate the cost to break a lease, including rent remaining, lease-break fees, notice-period rent, security deposit risk, reletting fees, rent until replaced, overlap, and new rent savings.',
    category: 'Moving',
    calculatorCategory: 'Moving',
  ...
  },
  {
    ...
    description: 'Score whether moving makes financial and practical sense by weighing upfront cash, monthly impact, lease timing, savings, debt, commute, safety, job reasons, and budget flexibility.',
    category: 'Moving',
    calculatorCategory: 'Moving',
